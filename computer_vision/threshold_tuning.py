...
# Set Initial Positions of Trackbar
cv2.setTrackbarPos("Brightness", "Webcam", 45)
...
color = "G"
cv2.setTrackbarPos(f"Low_H_{color}", f"Trackbars_{color}",66)
cv2.setTrackbarPos(f"High_H_{color}", f"Trackbars_{color}",103)
...
while True:
    ...
    brightness = cv2.getTrackbarPos("Brightness", "Webcam") - 50  # Centered at 0
